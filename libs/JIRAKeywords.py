...
methods via JIRALibrary calls in Robot Framework. It is forked from https://github.com/IlfirinPL/robotframework-jira
"""
...
class JIRAKeywords(object):
    ...
    def connect_to_jira(self, url=None, username=None, password=None, **kwargs):
        ...
        """
        self._session = Jira(url=url, username=username,
